            ...
            for line in record.order_line:
                row_pos = self._write_line(
                    ...
                    render_space={
                        ...
                        'street': record.partner_shipping_id.street,
                        'street2': record.partner_shipping_id.street2,
                        'l10n_mx_edi_colony': record.partner_shipping_id.l10n_mx_edi_colony,
                        'city': record.partner_shipping_id.city,
                        'house_ref': record.partner_shipping_id.house_ref,
                        'country_id': record.partner_shipping_id.country_id.name,
                        'phone': record.partner_shipping_id.phone,                        
